...
public class IAPManager : Singleton<IAPManager>, IDetailedStoreListener
{
    ...
    const string PACK_1 = "com.breakout.pack1";
    const string PACK_2 = "com.breakout.pack2";
    const string PACK_3 = "com.breakout.pack3";
    const string PACK_4 = "com.breakout.pack4";
    const string PACK_5 = "com.breakout.pack5";
    const string PACK_6 = "com.breakout.pack6";
    const string PACK_7 = "com.breakout.pack7";
    const string PACK_8 = "com.breakout.pack8";
